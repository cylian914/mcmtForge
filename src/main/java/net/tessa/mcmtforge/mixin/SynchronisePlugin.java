...
/*        mixin2MethodsMap.put("net.tessa.mcmtforge.mixin.ServerChunkManagerMixin", mappingResolver.mapMethodName("intermediary", "net.minecraft.class_3215", "method_14161", "()V"));
//        mixin2MethodsMap.put("net.tessa.mcmtforge.mixin.ServerTickSchedulerMixin", mappingResolver.mapMethodName("intermediary", "net.minecraft.class_1949", "method_8670", "()V"));
//        mixin2MethodsMap.put("net.tessa.mcmtforge.mixin.ServerTickSchedulerMixin", mappingResolver.mapMethodName("intermediary", "net.minecraft.class_1949", "method_20514", "(Lnet/minecraft/class_1954;)V"));
//        mixin2MethodsMap.put("net.tessa.mcmtforge.mixin.ServerTickSchedulerMixin", mappingResolver.mapMethodName("intermediary", "net.minecraft.class_1949", "method_8672", "(Lnet/minecraft/class_3341;ZZ)Ljava/util/List;"));
//        mixin2MethodsMap.put("net.tessa.mcmtforge.mixin.ServerWorldMixin", mappingResolver.mapMethodName("intermediary", "net.minecraft.class_1937", "method_19282", "(Lnet/minecraft/class_2338;Lnet/minecraft/class_2680;Lnet/minecraft/class_2680;)V"));
//        mixin2MethodsMap.put("net.tessa.mcmtforge.mixin.LevelPropagatorMixin", mappingResolver.mapMethodName("intermediary", "net.minecraft.class_3554", "method_15492", "(I)I"));
//        mixin2MethodsMap.put("net.tessa.mcmtforge.mixin.LevelPropagatorMixin", mappingResolver.mapMethodName("intermediary", "net.minecraft.class_3554", "method_15478", "(JJIZ)V"));
        mixin2MethodsMap.put("net.tessa.mcmtforge.mixin.ChainRestrictedNeighborUpdaterMixin", mappingResolver.mapMethodName( "net.minecraft.class_7159", "method_41706", "(Lnet/minecraft/class_2338;Lnet/minecraft/class_7159$class_7162;)V"));
        mixin2MethodsMap.put("net.tessa.mcmtforge.mixin.ServerChunkManagerMixin", mappingResolver.mapMethodName( "net.minecraft.class_3215", "method_21738", "(JLnet/minecraft/class_2791;Lnet/minecraft/class_2806;)V"));
